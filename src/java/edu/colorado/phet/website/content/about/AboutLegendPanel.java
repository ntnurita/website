...
public class AboutLegendPanel extends PhetPanel {
    public AboutLegendPanel( String id, PageContext context ) {
        ...
        add( new StaticImage( "gold-star-image", Images.GOLD_STAR_LARGE, getPhetLocalizer().getString( "tooltip.legend.goldStar", this ) ) );
        ...
        add( new LocalizedText( "about-legend-gold-star", "about.legend.gold-star" ) );
