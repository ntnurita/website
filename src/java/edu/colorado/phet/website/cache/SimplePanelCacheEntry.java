...
public abstract class SimplePanelCacheEntry extends AbstractPanelCacheEntry implements Serializable {
    ...
    public SimplePanelCacheEntry( Class panelClass, Class parentClass, Locale locale, String parentCacheId, PhetRequestCycle cycle ) {
        super( panelClass, parentClass, locale, parentCacheId + "_" + DistributionHandler.getDistributionCacheKey( cycle ) + "_" + ( PhetRequestCycle.get().isOriginalSecure() ? "secure" : "insecure" ) );
    }
