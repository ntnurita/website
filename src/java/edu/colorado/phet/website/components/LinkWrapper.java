...
/**
 * Wraps a link around a child element
 */
public abstract class LinkWrapper extends PhetPanel {
    private Link link;

    public abstract Component createChild( String id );

    public LinkWrapper( String id, PageContext context, Linkable linker ) {
        super( id, context );
