...
public class StringChanges {
    ...
    public static void checkNewStrings() {
        ...
        StringUtils.overwriteString( session, "troubleshooting.javaSecurity.steps", "If you are a user of PhET simulations and are currently running Java 7, we recommend that you take the following steps in order to configure your computer to run safely and yet still be able to use PhET simulations:", "If you are a user of PhET simulations, are currently running Java 7 and want to still be able to use PhET simulations, we recommend that you take the following steps:" );
