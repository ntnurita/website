...
public class Images {
    ...
    public static final ImageHandle HTML5_BADGE = new ImageHandle( "/images/icons/sim-badges/html5-badge.png", true );
    public static final ImageHandle JAVA_BADGE = new ImageHandle( "/images/icons/sim-badges/java-badge.png", true );
    public static final ImageHandle FLASH_BADGE = new ImageHandle( "/images/icons/sim-badges/flash-badge.png", true );
    ...
    public static final ImageHandle NEWSLETTER_MAY_11 = new ImageHandle( "/images/phet_newsletter_may_11_thumbnail.png", true );
    public static final ImageHandle NEWSLETTER_NOVEMBER_11 = new ImageHandle( "/images/phet_newsletter_november_11_thumbnail.png", true );
...
//    public static final ImageHandle LOGO_NSF_FRONT_PAGE = new ImageHandle( "/images/support/nsf1-web.gif", true );
    ...
    public static final ImageHandle LOGO_MCGRAW_HILL = new ImageHandle( "/images/support/mcgraw-hill-small.png", true );
