...
trait IMSLODEILOXConverter extends PhetMetadataConverter {
  ...
  def convertRecord(record: SimulationRecord): Node = {
    ...
    <work xmlns="http://www.imsglobal.org/xsd/imsloilox_v1p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
      ...
      <!-- all licenses that the simulation is covered by -->{record.licenseURLs.map(licenseURL => <description>
      <facet>
        <vocabularyID>LRE.workDescriptionFacetValues</vocabularyID> <value>license</value>
      </facet>
      <metadata>
        ...
        <lom xsi:schemaLocation="http://ltsc.ieee.org/xsd/LOM/imslode/ilox/any/rights
          ...
          <rights>
            <cost>
              <source>costValues</source> <value>no</value>
            </cost>
            <copyrightAndOtherRestrictions>
              <source>copyrightAndOtherRestrictionsValues</source> <value>yes</value>
            </copyrightAndOtherRestrictions>
            <description>
              <string language={if ( licenseURL.contains("by/3.0") ) "x-t-cc-url" else "x-t-rights-url"}>
                {licenseURL}
              </string>
            </description>
          </rights>
    ...
    </description>)}<!-- main simulation information -->
      <description>
        <facet>
          ...
          <lom xmlns="http://ltsc.ieee.org/xsd/LOM"
            ...
            <educational>
              ...
              <learningResourceType>
                <source>LRE.learningResourceTypeValues</source> <value>simulation</value>
              </learningResourceType>

              <!-- intended user roles -->
              <intendedEndUserRole>
                <source>LRE.intendedEndUserRoleValues</source> <value>teacher</value>
              </intendedEndUserRole>
              <intendedEndUserRole>
                <source>LRE.intendedEndUserRoleValues</source> <value>learner</value>
              </intendedEndUserRole>

              <!-- contexts -->
              <context>
                <source>LRE.contextValues</source> <value>compulsory education</value>
              </context>
              <context>
                <source>LRE.contextValues</source> <value>higher education</value>
              </context>
              <context>
                <source>LRE.contextValues</source> <value>distance education</value>
              </context>
      ...
      <!-- expression for each language -->{record.languages.map(language =>
                                                                   <expression>
                                                                     <dimension>
                                                                       <name>
                                                                         <vocabularyID>LRE.expressionDimensionNameValues</vocabularyID> <value>language</value>
                                                                       </name>
                                                                       <parameter>
                                                                         <vocabularyID>languageListValues</vocabularyID> <value>
                                                                         {language}
                                                                       </value>
                                                                       </parameter>
                                                                     </dimension>
                                                                     ...
                                                                     <manifestation>
                                                                       <name>
                                                                         <vocabularyID>LRE.manifestationNameValues</vocabularyID> <value>
                                                                         {runNowManifestation}
                                                                       </value>
                                                                       </name>
                                                                       <item>
                                                                     ...
                                                                     <manifestation>
                                                                       <name>
                                                                         <vocabularyID>LRE.manifestationNameValues</vocabularyID> <value>package in</value>
                                                                       </name>
                                                                       <parameter>
                                                                         <vocabularyID>LRE.packageInValues</vocabularyID> <value>jar</value>
                                                                       </parameter>
                                                                       <item>
                                                                         <location>
                                                                           <uri>
                                                                             {record.downloadUrl(language)}
                                                                           </uri>
                                                                         </location>
                                                                       </item>
                                                                     </manifestation>
                                                                     ...
                                                                     <manifestation>
                                                                       <name>
                                                                         <vocabularyID>LRE.manifestationNameValues</vocabularyID> <value>thumbnail</value>
                                                                       </name>
                                                                       <item>
                                                                         <location>
                                                                           <uri>
                                                                     ...
                                                                     <manifestation>
                                                                       <name>
                                                                         <vocabularyID>LRE.manifestationNameValues</vocabularyID> <value>landing page</value>
                                                                       </name>
                                                                       <item>
                                                                         <location>
                                                                           <uri>
