 ...
 * <p/>
 * Example:
 * http://phet.colorado.edu/services/metadata/simulation?simulation=density&format=nsdl_dc
 */
public class SimulationMetadataFormatService extends WebPage {
    public SimulationMetadataFormatService( PageParameters parameters ) {
        super( parameters );
