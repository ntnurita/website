...
<head profile="http://gmpg.org/xfn/11">
    ...
    <link rel="stylesheet" href="<?php bloginfo( 'stylesheet_url' ); ?>" type="text/css" title="Yashfa Themes"
          media="screen"/>

    <script language="javascript" type="text/javascript"
            src="<?php bloginfo( 'template_directory' ); ?>/js/jquery-1.2.6.min.js"></script>
    <script language="javascript" type="text/javascript"
            src="<?php bloginfo( 'template_directory' ); ?>/js/jquery.equalheights.js"></script>
...
<div id="navr" style="display: none;">
    <div id="navr2">
        <ul class="menu clearfix">
            ...
            }?>><a href="<?php bloginfo( 'siteurl' ); ?>/" title="Home">Home</a></li>
        <?php wp_list_pages( 'sort_column=menu_order&title_li=' ); ?>
        <?php wp_register( '<li class="admintab">', '</li>' ); ?>
        </ul>
        <div class="feeder">
            <a rel="alternate" type="application/rss+xml" title="<?php bloginfo( 'name' ); ?> RSS Feed"
               href="<?php bloginfo( 'rss2_url' ); ?>"/>RSS</a>            </div>
    </div>
</div>
